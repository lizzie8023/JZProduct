...
{
//    if (iOS7Only) {
//        if ([touch.view.superview isKindOfClass:NSClassFromString(@"UITableViewCellScrollView")]) {
//            UIScrollView *s = (id)touch.view.superview;
//            if (s.contentOffset.x != 0) {
//                return NO;
//            }
//        }else if ([touch.view.superview isKindOfClass:NSClassFromString(@"UITableViewCellDeleteConfirmationView")]) {
//            return NO;
//        }
//    }
