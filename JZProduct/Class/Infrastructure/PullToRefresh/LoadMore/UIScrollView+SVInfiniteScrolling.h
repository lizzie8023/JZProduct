...
- (void)addSVInfiniteScrollingWithActionHandler:(nonnull void (^)(void))actionHandler;
...
- (void)setCustomView:(nonnull UIView *)view forState:(SVInfiniteScrollingState)state;
